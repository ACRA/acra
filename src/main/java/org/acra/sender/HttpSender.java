...
public class HttpSender implements ReportSender {
     ...
     */
    public HttpSender(ACRAConfigX config, Method method, Type type, Map<ReportField, String> mapping) {
     ...
     *            mapping.get(ReportField.SOME_FIELD);
     */
    public HttpSender(ACRAConfigX config, Method method, Type type, String formUri, Map<ReportField, String> mapping) {
        this.config = config;
        mMethod = method;
