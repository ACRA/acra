...
**ACRA 4.3.0 is now the official stable version.**
...
A more detailed description of the changes has been introduced in [this Google+ post](https://plus.google.com/b/118444843928759726538/118444843928759726538/posts/cnABXX7bbxV), based on the [ChangeLog](http://code.google.com/p/acra/wiki/ChangeLog).
...
See [BasicSetup](http://code.google.com/p/acra/wiki/BasicSetup) for a step-by-step installation and usage guide.
...
A crash reporting feature for android apps is native since Android 2.2 (FroYo) but only available through the official Android Market (and with limited data). ACRA is a great help for Android developers :
  ...
  * [developer configurable user interaction](http://code.google.com/p/acra/wiki/AdvancedUsage#User_Interaction): silent reports, Toast notification, status bar notification + dialog or direct dialog
  ...
  * more [detailed crash reports](http://code.google.com/p/acra/wiki/ReportContent) about the device running the app than what is displayed in the Android Market developer console error reports
  * you can [add your own variables content or debug traces](http://code.google.com/p/acra/wiki/AdvancedUsage#Adding_your_own_variables_content_or_traces_in_crash_reports) to the reports
  * you can send [error reports even if the application doesn't crash](http://code.google.com/p/acra/wiki/AdvancedUsage#Sending_reports_for_caught_exceptions_or_for_unexpected_applicat)
  ...
  * can be used with [your own self-hosted report receiver script](http://code.google.com/p/acra/wiki/AdvancedUsage#Reports_destination)
...
Please do not hesitate to open defects/enhancements requests in [the issue tracker](http://code.google.com/p/acra/issues/list).
...
You can read in the [ChangeLog](http://code.google.com/p/acra/wiki/ChangeLog) that many things have been added since ACRA 3.1. Here is a summary:
  ...
  * Custom report receiver server scripts can be secured with basic http authentication (login/password can be co                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           nfigured in ACRA)
...
You can look at [some contributions](http://code.google.com/p/acra/wiki/Contribs) that have already been published. Most of them are work in progress, so if you feel like joining the effort, please do!