...
Acra requires at least java 11. This can be configured in various ways, our examples use toolchains for [Java](https://github.com/ACRA/acra/blob/master/examples/acra-basic-java-example/build.gradle.kts#L33) and [Kotlin](https://github.com/ACRA/acra/blob/master/examples/acra-basic-kotlin-example/build.gradle.kts#L35).
