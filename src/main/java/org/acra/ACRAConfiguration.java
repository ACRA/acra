...
public class ACRAConfiguration implements ReportsCrashes {
    ...
    private Class<? extends CrashReportDialog> mReportDialogClass = null;
    ...
    @SuppressWarnings( "unused" )
    public ACRAConfiguration setReportDialogClass(Class<? extends CrashReportDialog> reportDialogClass) {
    ...
    @Override
    public Class<? extends CrashReportDialog> reportDialogClass() {
