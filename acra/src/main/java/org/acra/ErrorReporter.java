...
public class ErrorReporter implements Thread.UncaughtExceptionHandler {
     ...
     *
     * Calling this method will ensure that all previously caught (but not yet sent) reports are deleted.
     * This might be useful when upgrading and you want to remove all reports generated by the old version.
     * If so then calling this in {@link android.app.Application#onCreate} where you are tracking app version numbers
     * or in {@link android.database.sqlite.SQLiteOpenHelper#onUpgrade} as part of your database upgrade will remove old errors.
     */
    public final void deletePendingReports() {
