...
public class CrashReportData extends EnumMap<ReportField, String> {
     ...
     * ISO8859-1.
     * 
     * @param in    {@code InputStream} from which to load the values for this CrashReportData.
     ...
     * @since 1.6
     */
    private synchronized void load(Reader reader) throws IOException {
     ...
     * 
     * @param out       OutputStream to which to store this CrashReportData.
     * @param comment   String to add as a comment at the top of the OutputStream.
     * @throws IOException if this CrashReportData could not be written to the OutputStream.
     * 
