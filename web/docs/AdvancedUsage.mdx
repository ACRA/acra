...
See [`attachmentUris`](pathname:///javadoc/latest/acra/org.acra.annotation/-acra-core/attachment-uris.html) for details on how to format your uri strings. Alternatively you can use your own `ContentProvider` with a respective uri.
